      ...
      <footer style={{ backgroundColor: "#f7f7f7" }}>
        <div className="container mt-5 py-md-3 py-lg-5 py-3">
          <div className="row pt-5 px-md-3 pt-md-3 pb-3 ">
            <div className="col-lg-6">
              <div className="row">
                ...
                <div className="col-6">
                  <div className="h5 fw-bold">
                    <small>Popular KFC Restaurants</small>
                  </div>
                  <div className="p pt-3">
                    <a className="footer-link">
                      <small>KFC Branch, Bishop Stage Mukono</small>
                    </a>
                  </div>
                  <div className="p pt-3">
                    <a className="footer-link">
                      <small>KFC Nile, Jinja</small>
                    </a>
                  </div>
                  <div className="p pt-3">
                    <a className="footer-link">
                      <small>Akapela Restaurant, KFC Bweyogerere</small>
                    </a>
                  </div>
                  <div className="p pt-3">
                    <a className="footer-link">
                      <small>Eaters' Hub, KFC Nakawa</small>
                    </a>
                  </div>
                  <div className="p pt-3">
                    <a className="footer-link">
                      <small>Krepin Restaurant, KFC Mbarara</small>{" "}
                    </a>
                  </div>
                  <div className="p pt-3">
                    <a className="footer-link">
                      <small>KFC Fried Chicken</small>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-6">
              <div className="row pt-5 pt-lg-0">
                ...
                <div className="col-6 pt-3 pt-lg-0">
                  <div className="h5 fw-bold">
                    <small>Take The Chicken With you</small>
                  </div>
          ...
          <div className="row pt-5 pt-lg-0 pb-3 px-lg-3">
            ...
            <h2 style={{textAlign: "center"}}>We are Kentucky Fried Chicken!</h2>
            <div className="col-12">
              <div className="row">
                <div className="col-6">
                  <img
