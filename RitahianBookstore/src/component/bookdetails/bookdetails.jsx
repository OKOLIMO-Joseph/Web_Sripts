                ...
                <div className="container">
                    <div className="bookdetails">
                        ...
                        <div className="col-md-8 p-2">
                            ...
                            <p className="lead mb-5 w-50" style={{ color: "black" }}>Ritahian Bookstore comes in with a full package of realms or poetry, creativity and fine literature, all hardcoded in the pages. </p>
